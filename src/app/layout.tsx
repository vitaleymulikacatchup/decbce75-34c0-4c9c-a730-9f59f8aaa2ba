...
export const metadata: Metadata = {
  title: "Car Showcase - Luxury Vehicles",
  description: "Explore our premium selection of luxury cars. Discover features, pricing, and book your test drive.",
  keywords: "luxury cars, car features, vehicle showcase, premium cars",
  metadataBase: new URL("https://car-showcase.example.com"),
  alternates: {
    canonical: "https://car-showcase.example.com",
  },
  openGraph: {
    title: "Car Showcase - Luxury Vehicles",
    description: "Explore our premium selection of luxury cars.",
    url: "https://car-showcase.example.com",
  ...
  twitter: {
    ...
    title: "Car Showcase - Luxury Vehicles",
    description: "Explore our premium selection of luxury cars.",
    images: ["https://images.pexels.com/photos/34327213/pexels-photo-34327213.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"],
  },
  robots: {
    index: true,
    follow: true,
